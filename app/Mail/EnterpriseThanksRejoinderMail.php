...
class EnterpriseThanksRejoinderMail extends Mailable
{
    ...
    public function __construct(User $user, EnterpriseThanks $enterpriseThanks)
    {
        ...
        $this->subject = 'Agradeça Aqui - Sua empresa recebeu uma tréplica';
    }
    ...
    {
        return $this->view('emails.enterprise-thanks-rejoinder.send')
                    ->with([
                        'userName' => $this->user->name,
                        'userEmail' => $this->user->email,
                        'content' => $this->enterpriseThanks->content,
                        'replica' => $this->enterpriseThanks->replica,
                        'rejoinder' => $this->enterpriseThanks->rejoinder,
