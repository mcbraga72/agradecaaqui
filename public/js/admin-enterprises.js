...
new Vue({
    ...
    data: {
        ...
        formErrors:{},
        formErrorsUpdate:{},
        newEnterprise : {'category_id': '','name': '','contact': '','email': '','site': '','telephone': '','address': '','neighborhood': '','city': '','state': '','cpf': '','cnpj': '','logo': '','password': '','passwordConfirm': ''},
        fillEnterprise : {'category_id': '','name': '','contact': '','email': '','site': '','telephone': '','address': '','neighborhood': '','city': '','state': '','cpf': '','cnpj': '','id': ''},
        sortProperty: 'name',
        sortDirection: 1,
        filterTerm: '',
        statesCities: {      
    ...
    computed: {
        ...
        let options = ''
            ...
            switch(this.newEnterprise.state) {
                ...
                case 'Alagoas':
                options = this.statesCities.Alagoas
                break;

                case 'Amazonas':
                options = this.statesCities.Amazonas
                break;

                case 'Amapá':
                options = this.statesCities.Amapa
                break;

                case 'Bahia':
                options = this.statesCities.Bahia
                break;

                case 'Ceará':
                options = this.statesCities.Ceara
                break;

                case 'Distrito Federal':
                options = this.statesCities.DistritoFederal
                break;

                case 'Espírito Santo':
                options = this.statesCities.EspiritoSanto
                break;

                case 'Goiás':
                options = this.statesCities.Goias
                break;
                
                case 'Maranhão':
                options = this.statesCities.Maranhao
                break;

                case 'Minas Gerais':
                options = this.statesCities.MinasGerais
                break;

                case 'Mato Grosso do Sul':
                options = this.statesCities.MatoGrossoDoSul
                break;

                case 'Mato Grosso':
                options = this.statesCities.MatoGrosso
                break;

                case 'Pará':
                options = this.statesCities.Para
                break;

                case 'Paraíba':
                options = this.statesCities.Paraiba
                break;
                
                case 'Paraná':
                options = this.statesCities.Parana
                break;

                case 'Pernambuco':
                options = this.statesCities.Pernambuco
                break;
                
                case 'Piauí':
                options = this.statesCities.Piaui
                break;

                case 'Rio de Janeiro':
                options = this.statesCities.RioDeJaneiro
                break;

                case 'Rio Grande do Norte':
                options = this.statesCities.RioGrandeDoNorte
                break;

                case 'Rio Grande do Sul':
                options = this.statesCities.RioGrandeDoSul
                break;

                case 'Rondônia':
                options = this.statesCities.Rondonia
                break;

                case 'Roraima':
                options = this.statesCities.Roraima
                break;
                
                case 'Santa Catarina':
                options = this.statesCities.SantaCatarina
                break;

                case 'São Paulo':
                options = this.statesCities.SaoPaulo
                break;

                case 'Sergipe':
                options = this.statesCities.Sergipe
                break;
                
                case 'Tocantins':
                options = this.statesCities.Tocantins
                break;
            }
        ...
        let options = ''
            ...
            switch(this.fillEnterprise.state) {
    ...
    methods : {
        ...
        createEnterprise: function(){
            if (this.newEnterprise.password == this.newEnterprise.passwordConfirm) {
		        ...
		        this.$http.post('/admin/empresas',input).then(function(response) {
			        ...
			        this.newEnterprise = {'category_id': '','name':'','contact': '','email':'','site': '','telephone': '','address': '','neighborhood': '','city': '','state': '','cpf': '','cnpj': '','logo': '','password': '','passwordConfirm': ''};
        ...
        editEnterprise: function(enterprise){
            ...
            this.fillEnterprise.neighborhood = enterprise.neighborhood;
            this.fillEnterprise.city = enterprise.city;
            this.fillEnterprise.state = enterprise.state;
            this.fillEnterprise.cpf = enterprise.cpf;
            this.fillEnterprise.cnpj = enterprise.cnpj;
        ...
        updateEnterprise: function(id){
            ...
            this.$http.put('/admin/empresas/'+id,input).then(function(response) {
                this.changePage(this.pagination.current_page);
                this.fillEnterprise = {'category_id': '','name':'','contact': '','email':'','site': '','telephone': '','address': '','neighborhood': '','city': '','state': '','cpf': '','cnpj': '','id':''};
