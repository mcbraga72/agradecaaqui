                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/categoria') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <!--<button type="submit" class="btn btn-success"><span><i class="fa fa-check"></i></span>Atualizar</button>-->
                                {!! Form::open(array('method' => 'put', 'action' => array('CategoryAdminController@update', $category->id))) !!}
                                {{ Form::button('<i class="fa fa-pencil-square-o"></i>', array('type' => 'submit', 'class' => 'btn btn-success'))}}
