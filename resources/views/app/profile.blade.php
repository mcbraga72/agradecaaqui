		...
		<div class="row">
            <div class="col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 home">
            	<script type="text/javascript"> 
	                ...
	                $(document).ready(function () {
	                    ...
	                    $.getJSON('{{ URL::to('/') }}/paises.json', function (data) {
	                        ...
	                        $("#country").appendTo(options);
	                        
	                    });

	                    $(function() {
		                    $("#country").val('{{ Auth::user()->country }}');
		                    $("#state").val('Selecione o estado');
				...
				<div class="form-group col-lg-12 form-box">
	                ...
	                {{ csrf_field() }}
	                    <div class="form-group col-lg-5 profile-item">
	                        <label for="photo" class="btn"><img src="{{ Auth::user()->photo }}" style="border-radius: 50%;" /></label>
	                        <button type="submit" class="btn btn-primary profile-item" style="display: inline !important;">Atualizar Foto</button>
	            ...
	            <div class="form-group col-lg-12 form-box">
		            <form class="profile-form" method="POST" enctype="multipart/form-data" action="/app/usuario/{{ Auth::user()->id }}">
		                {{ csrf_field() }}    
		                ...
		                <div class="form-group col-lg-4 profile-item">
		                    ...
		                    <input type="text" name="height" class="form-control" value="{{ Auth::user()->height }}" maxlength="4" onkeypress="formatHeight(this)" />
		                    
		                </div>
		                <div class="form-group col-lg-4 profile-item">
		                    <label for="weight">Peso(kg)</label>
		                    <input type="text" name="weight" class="form-control" value="{{ Auth::user()->weight }}" maxlength="3" onkeypress="formatWeight(this,event)" />
