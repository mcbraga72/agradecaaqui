...
class EnterpriseThanksAdminControllerTest extends TestCase
{
    ...
    {
    	$response = $this->get('/admin/agradecimentos-empresas/listar');
    ...
    public function testIndex()
    {
    	...
    	$this->call('GET', '/admin/agradecimentos-empresas')
    		 ->assertJsonStructure([
    		 		'pagination' => [
